...
== Upgrade Notice ==
= 1.2.9 =
Fixed another important quote problem with JavaScript. Fixed quote not working with HTML editor with fancy editor. Fixed scroll and use of trim in JavaScript with IE7 and IE8. Fixed problem with quote that breaks the oEmbed.
